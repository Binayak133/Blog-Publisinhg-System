...
$url = URL::to("/").'/posts/'.$file->getClientOriginalName();
        ...
        $posts->save();
        return redirect('/home')->with('response','Posts Added Successfully');
    }
        public function view($post_id)
        {
            ...
            return view('posts.view',['categories'=> $categories, 'posts' => $posts,'likeCtr' => $likeCtr ,'dislikeCtr' => $dislikeCtr,'comments' => $comments]);
        }
        ...
        public function edit($post_id)
        {
            ...
            return view('posts.edit',compact('categories'),compact('posts'),compact('category'));
        }
    ...
    public function deletePost(Request $request,$post_id)
    {
        ...
        ->delete();
        return redirect('/home')->with('response','Posts Deleted Successfully');
    }
    ...
    public function category($cat_id)
    {
        ...
        ->get();
        return view('categories.categoriesposts',compact('categories'),compact('posts'));
    }
